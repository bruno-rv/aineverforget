...
| `RETRIEVER_AGENT` | `.claude/agentspec/agents/dev/knowledge-retriever.md` | Agent file |
| `SYNTHESIZER_AGENT` | `.claude/agentspec/agents/dev/answer-synthesizer.md` | Agent file |
...
▶ DISPATCH knowledge-retriever
  Agent:         .claude/agentspec/agents/dev/knowledge-retriever.md
  Input:
