...
| `NOTE_SUMMARIZER_AGENT` | `.Codex/agentspec/agents/dev/note-summarizer.md` | Agent file |
| `KNOWLEDGE_INDEXER_AGENT` | `.Codex/agentspec/agents/dev/knowledge-indexer.md` | Agent file |
...
▶ DISPATCH note-summarizer
  Agent:    .Codex/agentspec/agents/dev/note-summarizer.md
...
▶ DISPATCH knowledge-indexer
  Agent:    .Codex/agentspec/agents/dev/knowledge-indexer.md
